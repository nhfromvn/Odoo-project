    ...
    <div id="navBar">
      ...
      <div
        ...
        <div v-if="!show_chart" class="page_control" @click="showChart"
             style="font-size: 22px; font-weight: 400;text-align: center;padding: 12px 12px;">Analytics
        </div>
        <div v-else class="page_control" @click="showChart"
             style="font-size: 22px; font-weight: 400;text-align: center;padding: 12px 12px;">Settings
        </div>
        <div class="page_control"
             style="font-size: 22px; font-weight: 400;text-align: center;padding: 12px 12px;"
